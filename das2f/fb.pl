...
diagram_fact(source, cell_14, id_EtBca3zEvNpn1HgqioBE__1).
...
diagram_fact(synonym, cell_14, id_EtBca3zEvNpn1HgqioBE__3).
diagram_fact(synonym, cell_15, id_EtBca3zEvNpn1HgqioBE__1).
diagram_fact(synonym, cell_16, id_EtBca3zEvNpn1HgqioBE__2).
...
diagram_fact(target, cell_14, id_EtBca3zEvNpn1HgqioBE__2).
...
diagram_fact(x, cell_15, 150).
diagram_fact(x, cell_16, 230).
diagram_fact(x, cell_6, 170).
diagram_fact(x, cell_7, 250).
...
diagram_fact(y, cell_15, 285).
diagram_fact(y, cell_16, 285).
...
das_fact(name, cell_15, "a").
das_fact(name, cell_16, "b").
...
das_fact(bbL,cell_15,150).
  das_fact(bbT,cell_15,285).
  das_fact(bbR,cell_15,190).
  das_fact(bbB,cell_15,325).
das_fact(bbL,cell_16,230).
  das_fact(bbT,cell_16,285).
  das_fact(bbR,cell_16,270).
  das_fact(bbB,cell_16,325).
das_fact(bbL,cell_6,170).
  das_fact(bbT,cell_6,170).
  das_fact(bbR,cell_6,630).
  das_fact(bbB,cell_6,650).
das_fact(bbL,cell_7,250).
